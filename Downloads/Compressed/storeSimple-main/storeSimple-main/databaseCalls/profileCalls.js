...
module.exports = {myProfileAddresses, myProfileDetails}
// module.exports = myProfileDetails
...
// myProfileAddresses({userId: "1"})

// myDynamo.get().promise().then(res=console.log).then().then().catch()